...
echo "SWISS PROT"
echo "5-shot methods with 40 epochs, backbone sizes = [512, 256]"
python run.py dataset=swissprot method=matchingnet n_shot=5 exp.name=matchingnet_swissprot_5_shot_embedding_512_256 backbone.layer_dim=[512,256]
python run.py dataset=swissprot method=protonet n_shot=5 exp.name=protonet_swissprot_5_shot_embedding_512_256 backbone.layer_dim=[512,256]
python run.py dataset=swissprot method=maml n_shot=5 exp.name=maml_swissprot_5_shot_5_updates_innerlr_002_embedding_512_256 method.task_update_num=5 method.maml_inner_lr=0.002 backbone.layer_dim=[512,256]

echo "5-shot methods with 40 epochs, backbone sizes = [512, 1024]"
python run.py dataset=swissprot method=matchingnet n_shot=5 exp.name=matchingnet_swissprot_5_shot_embedding_512_1024 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=protonet n_shot=5 exp.name=protonet_swissprot_5_shot_embedding_512_1024 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=maml n_shot=5 exp.name=maml_swissprot_5_shot_5_updates_innerlr_002_embedding_512_1024 method.task_update_num=5 method.maml_inner_lr=0.002 backbone.layer_dim=[512,1024]

echo "5-shot metaoptnet-svm with 40 epochs, backbone sizes = [512, 256], varying C_reg"
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_10_maxiter_3_embedding_512_256 method.base_learner=svm method.C_reg=10 backbone.layer_dim=[512,256]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_5_maxiter_3_embedding_512_256 method.base_learner=svm method.C_reg=5 backbone.layer_dim=[512,256]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_1_maxiter_3_embedding_512_256 method.base_learner=svm method.C_reg=1 backbone.layer_dim=[512,256]

echo "5-shot metaoptnet-svm with 40 epochs, backbone sizes = [512, 1024], varying C_reg"
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_100_maxiter_3_embedding_512_1024 method.base_learner=svm method.C_reg=100 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_50_maxiter_3_embedding_512_1024 method.base_learner=svm method.C_reg=50 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_20_maxiter_3_embedding_512_1024 method.base_learner=svm method.C_reg=20 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_10_maxiter_3_embedding_512_1024 method.base_learner=svm method.C_reg=10 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_5_maxiter_3_embedding_512_1024 method.base_learner=svm method.C_reg=5 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_svm_swissprot_5_shot_C_reg_1_maxiter_3_embedding_512_1024 method.base_learner=svm method.C_reg=1 backbone.layer_dim=[512,1024]

echo "5-shot metaoptnet-ridge with 40 epochs, backbone sizes = [512, 256], varying lambda_reg"
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_10_embedding_512_256 method.base_learner=ridge method.lambda_reg=10 backbone.layer_dim=[512,256]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_5_embedding_512_256 method.base_learner=ridge method.lambda_reg=5 backbone.layer_dim=[512,256]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_1_embedding_512_256 method.base_learner=ridge method.lambda_reg=1 backbone.layer_dim=[512,256]

echo "5-shot metaoptnet-ridge with 40 epochs, backbone sizes = [512, 1024], varying lambda_reg"
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_10_embedding_512_1024 method.base_learner=ridge method.lambda_reg=10 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_5_embedding_512_1024 method.base_learner=ridge method.lambda_reg=5 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_1_embedding_512_1024 method.base_learner=ridge method.lambda_reg=1 backbone.layer_dim=[512,1024]
python run.py dataset=swissprot method=metaoptnet n_shot=5 exp.name=metaoptnet_ridge_swissprot_5_shot_lambda_reg_01_embedding_512_1024 method.base_learner=ridge method.lambda_reg=0.1 backbone.layer_dim=[512,1024]
