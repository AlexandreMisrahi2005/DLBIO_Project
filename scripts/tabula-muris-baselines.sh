...
# MAML-specific parameters: inner LR and number of updates
python run.py dataset=tabula_muris method=maml n_shot=5 exp.name=maml_tabula_muris_5_shot_1_update_60_epochs method.task_update_num=1 method.maml_inner_lr=0.01 method.stop_epoch=60
python run.py dataset=tabula_muris method=maml n_shot=5 exp.name=maml_tabula_muris_5_shot_5_updates_innerlr_002_60_epochs method.task_update_num=5 method.maml_inner_lr=0.002 method.stop_epoch=60
